          ...
          >
            <div className="aspect-square rounded-3xl bg-gradient-to-br from-card to-secondary border border-border overflow-hidden relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
                <div className="font-display text-6xl md:text-8xl font-bold text-gradient">10+</div>
              ...
              <div className="absolute bottom-8 left-8 w-24 h-24 rounded-xl bg-secondary border border-border flex items-center justify-center animate-float" style={{ animationDelay: "-3s" }}>
                <span className="text-2xl font-display font-bold text-accent">SMM</span>
              </div>
            </div>
          </motion.div>
        </div>
